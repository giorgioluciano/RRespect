function [harmonicsR, harmonicsI] = KBKZmodelSimpsonLaun(para)

% KBKZ original model using simpson rule for integration 
...
% axis([0 6 0 100] );
% axis 'auto y';
harmonics = [interp1(f,P1, 1.0), interp1(f,P1, 3.0),  interp1(f,P1, 5.0)];
...
harmonicsR = [interp1(f,P1r, 1.0), interp1(f,P1r, 3.0),  interp1(f,P1r, 5.0)];
harmonicsR = harmonicsR/Amp;
...
harmonicsI = [interp1(f,P1i, 1.0), interp1(f,P1i, 3.0),  interp1(f,P1i, 5.0)];
harmonicsI = harmonicsI/Amp;
